...
const (
	salt = "qyfeghquijqufnwskjo8214785324"
	signedKey = "hfyskjsoplm273457634ljbop"
...
func (s *AuthService) ParseToken(accessToken string) (int, error) {
	token, err := jwt.ParseWithClaims(accessToken, &tockenClaims{}, func(token *jwt.Token) (interface{}, error) {
